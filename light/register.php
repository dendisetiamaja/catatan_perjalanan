...
<!-- Mirrored from radixtouch.com/templates/admin/redstar/source/light/forgot_password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Oct 2021 14:50:45 GMT -->
<head>
	<meta charset="utf-8" />
		...
		<div class="container-login100">
			...
			<form class="user" method="post" action="proses_register.php">
					...
					<p class="text-center txt-small-heading">
						Belum Mempunyai Akun? Daftar Segera.
					</p>
